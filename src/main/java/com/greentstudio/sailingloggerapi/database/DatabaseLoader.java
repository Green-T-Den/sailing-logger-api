...
public class DatabaseLoader {
  ...
  CommandLineRunner initDatabase(BoatRepository boatRepository, PortRepository portRepository) {
    return args -> {
      ...
      Boat boatBoatyMcBoat =
          boatRepository.save(new Boat("BoatyMcBoat", "Green", Instant.now(), portHamburg));
      ...
      Boat boatDammi =
          boatRepository.save(new Boat("Dammi", "Black", Instant.now(), portRotterdam));
