...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  /**
   * Overrides the method in ResponseEntityExceptionHandler class, providing a more appropriate
   * exception handler.
   *
  ...
  public final ResponseEntity<Object> handleBoatNotFoundExceptions(
      BoatNotFoundException ex, WebRequest request) {
    ExceptionResponse exceptionResponse =
        new ExceptionResponse(new Date(), ex.getMessage(), request.getDescription(false));
