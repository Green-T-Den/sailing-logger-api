...
public class BoatControllerTest {
  ...
  @MockBean private BoatRepository boatRepository;
  ...
  public void getShouldFetchAHalDocument() throws Exception {
    ...
    mockMvc
        .perform(get("/boats").accept(MediaTypes.HAL_JSON_VALUE))
        .andDo(print())
        ...
        .andExpect(
            jsonPath("$._embedded.boats[0]._links.self.href", is("http://localhost/boats/1")))
        ...
        .andExpect(
            jsonPath("$._embedded.boats[1]._links.self.href", is("http://localhost/boats/2")))
